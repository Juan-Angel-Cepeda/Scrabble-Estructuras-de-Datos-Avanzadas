...
def main():
    ...
    #Cambiar ruta para ingresar el archivo "0_palabras.txt"
    path = 'C:\Ejercicios Progra\Estructuras de Datos Avanzadas\\0_palabras.txt'
    ...
    while(flag):
        ...
        if(opcion == 1):
            ...
            palabra = (str(input("""Ingrese la palabra a jugar: 
                                    Si desea pasar presione 1. """)))
